...
public class AlignmentClient {
	...
	final static Logger logger = LoggerFactory.getLogger(AlignmentClient.class);
	...
	public String createMessage(Properties params) throws Exception {
		...
		HashMap<String, HandleMessage> map = new HashMap<>();
		map.put("list", new HandleList());
		...
		map.put("upload", new HandleLoad());
		map.put("load", new HandleLoad());
		map.put("retrieve", new HandleRetrieve());
		map.put("metadata", new HandleMetadata());
		map.put("HandleUpload", new HandleUpload());
		if(map.containsKey(cmd)){
			messageBody = map.get(cmd).handle(params, RESTParams, cmd);		
		} else {
			usage();
			System.exit(-1);			
		}
	...
	private interface HandleMessage{
			public String handle(Properties params, String RESTParams, String cmd);
	}
	
	private class HandleList implements HandleMessage{
		public String handle(Properties params, String RESTParams, String cmd){
	...
	private class HandleWsdl implements HandleMessage{
		public String handle(Properties params, String RESTParams, String cmd){
	...
	private class HandleFind implements HandleMessage{
		public String handle(Properties params, String RESTParams, String cmd){
			String messageBody="";
	...
	private class HandleMatch implements HandleMessage{
		public String handle(Properties params, String RESTParams, String cmd){
			String messageBody="";
	...
	private class HandleAlign implements HandleMessage{
		public String handle(Properties params, String RESTParams, String cmd){
			String messageBody="";
			SOAPAction = "align";
			RESTAction = "align";
	...
	private class HandleTrim implements HandleMessage{
		public String handle(Properties params, String RESTParams, String cmd){
			String messageBody="";
	...
	private class HandleInvert implements HandleMessage{
		public String handle(Properties params, String RESTParams, String cmd){
			String messageBody="";
	...
	private class HandleStore implements HandleMessage{
		public String handle(Properties params, String RESTParams, String cmd){
			String messageBody="";
	...
	private class HandleUpload implements HandleMessage{
		public String handle(Properties params, String RESTParams, String cmd){
			String messageBody="";
	...
	private class HandleLoad implements HandleMessage{
		public String handle(Properties params, String RESTParams, String cmd){
			String messageBody="";
	...
	private class HandleRetrieve implements HandleMessage{
		public String handle(Properties params, String RESTParams, String cmd){
			String messageBody="";
	...
	private class HandleMetadata implements HandleMessage{
		public String handle(Properties params, String RESTParams, String cmd){
			String messageBody="";
			SOAPAction = "metadata";
			RESTAction = "metadata";
    ...
    private void transferFile( File f , FileInputStream fi , OutputStream os ){
		try {
	...
	private void swotchOpt(Getopt g, int c, Properties params){
			String arg;	
			switch (c) {
			case 'h':
				usage();
			...
			case 'd':
				...
				arg = g.getOptarg();
				if (arg != null)
					debug = Integer.parseInt(arg.trim());
				else
					debug = 4;
				break;
			case 'r':
			...
			case 'D':
				...
				if (index != -1) {
					params.setProperty(arg.substring(0, index), arg.substring(index + 1));
				} else {
